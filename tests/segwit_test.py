...
from pycoin_grs.encoding import double_sha256, to_bytes_32
from pycoin_grs.key import Key
from pycoin_grs.serialize import b2h, b2h_rev, h2b
from pycoin_grs.tx.pay_to import build_hash160_lookup, build_p2sh_lookup
from pycoin_grs.tx.script import tools
from pycoin_grs.tx.Tx import SIGHASH_ALL, SIGHASH_SINGLE, SIGHASH_NONE, SIGHASH_ANYONECANPAY, Tx
...
class SegwitTest(unittest.TestCase):
    ...
    def test_segwit_ui(self):
        # p2wpkh
        from pycoin_grs.ui import script_obj_from_address
