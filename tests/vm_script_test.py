...
from pycoin_grs.tx.Tx import TxIn, TxOut, Tx
from pycoin_grs.tx.script import ScriptError
from pycoin_grs.tx.script import errno
from pycoin_grs.tx.script import flags
from pycoin_grs.tx.script.tools import compile, disassemble
from pycoin_grs.tx.script.vm import check_script
...
def dump_failure_info(spend_tx, script_in, script_out, flags, flags_string, expected, actual, message, comment):
    ...
    def tbf(*args):
        ...
        from pycoin_grs.tx.script.tools import disassemble_for_opcode_data
